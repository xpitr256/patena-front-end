<template>
    <div class="mt-4">
        ...
        <setting-confirmation-modal ref="settingModal"
                                    @settingConfirmationModal="changeToDefaultSettings"></setting-confirmation-modal>

        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item">
                    <a class="black-text" href="#" v-on:click="goToStep(1)">{{ $t("views.design.breadcrumb.step1")
                        }}</a>
                </li>
                <li class="breadcrumb-item">
                    <a class="black-text" href="#" v-on:click="goToStep(3)">{{
                        $t("views.design.breadcrumb.step2InitialData") }}</a>
                </li>
                <li class="breadcrumb-item">
                    <a class="black-text" href="#" v-on:click="getStepBack">{{ $t("views.design.breadcrumb.step3")
                        }}</a>
                </li>
        ...
        <form class="mt-4" v-on:submit.prevent="onSubmit">
            <div class="button-wrap mt-4">
                <input class="hidden radio-label" v-model="useDefaultSettings" v-bind:value="true"
                       @click="settingsChoiceClick" type="radio" id="length-button"/>
                <label class="button-label" for="length-button">
                    <span>{{ $t("views.patenaSettings.useDefaultSettings") }}</span>
                </label>
                <input class="hidden radio-label" v-model="useDefaultSettings" v-bind:value="false" type="radio"
                       id="sequence-button" @click="settingsChoiceClick"/>
            ...
            <div class="tab-content" id="nav-tabContent" v-show="useDefaultSettings !== null">
                    ...
                    <div class="row">
                        <div class="col-md-3 grey-border">
                            <h5 class="mt-3 mb-2 font-weight-bold" :class="{ labelDisabled: useDefaultSettings }">{{
                                $t("views.patenaSettings.references") }}:</h5>
                            <div class="row align-items-center">
                                <div class="col col-md-auto">
                                    <div class="reference uvReference"
                                         :class="{ uvReferenceDisabled: useDefaultSettings }"></div>
                                </div>
                            ...
                            <div class="row align-items-center">
                                <div class="col col-md-auto">
                                    <div class="reference cReference"
                                         :class="{ cReferenceDisabled: useDefaultSettings }"></div>
                                </div>
                                <div class="col" :class="{ labelDisabled: useDefaultSettings }">
                            ...
                            <h5 class="mt-5 mb-2 font-weight-bold" :class="{ labelDisabled: useDefaultSettings }">{{
                                $t("views.patenaSettings.actions") }}:</h5>

                            <a href="#/" class="btn btn-link mb-2" v-on:click="restoreFrequencies"
                            ...
                            <toggle-button
                                    ...
                                    :labels="true"
                            />
                            <a href="#/" class="btn btn-link mb-2" v-on:click="changeUVSilent"
                               :class="{ disabled: useDefaultSettings }">
                            ...
                            <toggle-button
                                    ...
                                    :labels="true"
                            />
                            <a href="#/" class="btn btn-link mb-2" v-on:click="changeCysteine"
                               :class="{ disabled: useDefaultSettings }">
                                {{ $t("views.patenaSettings.avoidCysteine") }}
                            </a>
                        </div>
                        <div class="col-md-9">
                            <div class="form-row" v-for="(row, index) in frequencies"
                                 v-bind:class="{ 'mt-4': index === 0 }" :key="index">
                        ...
                        <div class="label-check">
                            <div class="custom-control custom-checkbox checkbox-lg">
                                <input type="checkbox" class="custom-control-input" id="checkbox-2"
                                       v-model="wantToSelectNetCharge" v-on:click="changeIWantToSelectNetCharge"/>
                ...
                <div class="tab-pane fade" id="nav-contact" role="tabpanel" aria-labelledby="nav-contact-tab">
                    ...
                    <div class="form-row" v-bind:key="index" v-for="(row, index) in algorithms"
            ...
            <div class="d-flex mt-4">
                <div>
                    <a href="#" class="btn btn-light" v-on:click="getStepBack"> <i class="fas fa-chevron-left"></i> {{
                        $t("views.getBack") }} </a>
                </div>
                <div class="ml-auto">
                    <button type="button" v-on:click="launchConfirmationModal" :disabled="isSendDisabled"
...
<script>
    ...
    export default {
            ...
            return {
                ...
                defaultAlgorithms: [
                    ...
                    [{name: "Waltz", active: true, description: "Waltz"}, {
                        name: "Amyloid pattern",
                        active: true,
                        description: "AmyloidPattern"
                    }]
                ],
                frequencies: [],
                defaultFrequencies: [
        ...
        methods: {
            ...
            preloadStep: function () {
                if (this.formData.stepFrom === 5) {
